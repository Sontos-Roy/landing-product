...
<div class="container-fluid p-0">
    ...
    <div class="d-flex flex-wrap justify-content-between mb-3">
        <h1 class="h3"><strong>All Product Categories</strong></h1>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card p-3">
                        <form action="{{route('admin.categories.store')}}" method="post" id="ajax_form">
                            @csrf
                            <div class="row">
                ...
                <table class="table table-hover my-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <a href="{{route('admin.categories.edit', $item->id)}}" class="btn btn-info m-1 modal_btn"><i class="align-middle" data-feather="edit"></i></a>
                                <form action="{{route('admin.categories.destroy', $item->id)}}" class="delete_form m-1" method="POST">
                                    @csrf
                                    @method('DELETE')
